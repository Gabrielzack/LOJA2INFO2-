...
<head>
    ...
    <title>LOJERA DO ZACKERSON</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        <a class="navbar-brand" href="index.php"><img src="assets/imagens/logo.jpg" alt="" width="90px"></a>
...
<header class="jumbotron my-4 home-banner" id="head">
    <div class="container">
        <h1 class="display-3">Bagulhos Veganos</h1>
        <p class="lead">Só tem fruta e verdura aqui</p>
